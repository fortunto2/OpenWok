...
## Phase 4: Deploy & Docs <!-- checkpoint:fc4766d -->
Update documentation, clean up, verify everything works.

### Tasks
- [x] Task 4.1: Update `CLAUDE.md` <!-- sha:0043f00 --> — add new API endpoints (`/api/public/economics`, `/api/admin/metrics`), new migrations (0003-0005), PostHog integration note, new frontend route (`/economics`).
- [x] Task 4.2: Update `docs/prd.md` <!-- sha:fc4766d --> — mark Phase 7 pilot-infra items as partially complete, add reference to this track.
- [x] Task 4.3: Run `make check` — ensure all tests pass, clippy clean, fmt clean. Fix any issues.
...
- [x] Linter clean (clippy zero warnings)
- [x] Build succeeds
- [x] Documentation up to date
- [x] No regressions in existing functionality (order flow, operator console)
